...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Worlds Store!</h1>
                    <p>We have the best cameras, watches, mobiles and shirts for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Redmi.png" alt="Redmi">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Redmi 9</h3>
            ...
            <footer class="footer">
                <div class="container">
                <center>
                    <p>Copyright &copy Worlds Store. All Rights Reserved.</p>

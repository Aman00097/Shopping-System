        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-3">
                    <div class="thumbnail">
                        <a href="products.php">
                            <img src="img/shirt.jpg" alt="Shirt" style="height:165px">
                        </a>
                        <center>
                            <div class="caption">
                ...
                <div class="col-xs-3">
                    <div class="thumbnail">
                        <a href="products.php">
                            <img src="img/mobile.jpg" alt="Mobile" style="height:165px">
                        </a>
                        <center>
                            <div class="caption">
                                <p id="autoResize">Mobile</p>
                                <p>Worlds best brand of Mobile.</p>
                            </div>
                        </center>
                    </div>
                </div>
